...
function getHtml() {
    return SVGatorPlayer.wrapPage("<svg cache-id=\"3ace937c4f874fbf843363133a61359d\" id=\"eu9dYqs23cJ1\" xmlns=\"http:\/\/www.w3.org\/2000\/svg\" xmlns:xlink=\"http:\/\/www.w3.org\/1999\/xlink\" viewBox=\"0 0 242 37\" shape-rendering=\"geometricPrecision\" text-rendering=\"geometricPrecision\"><path d=\"\" fill=\"none\" stroke=\"#3f5787\" stroke-width=\"0.6\"\/><path d=\"M-8.85008,21.944058c0-10.664619,7.173721-18.79502,17.83834-18.79502C58.000557,2.158567,65.757143,0.00339,71.481799,13.45776c9.307298,20.35541,23.711459,19.443973,31.689144-.303813C107.87334,0.540474,123.425216,1.878266,168.909797,3.149038c10.664619,0,15.887498,8.125098,15.887498,18.789717v.005304c0,10.664619-5.222879,19.830283-15.887498,19.830283h-159.921537c-10.664619,0-17.83834-9.160361-17.83834-19.82498v-.005304Z\" transform=\"matrix(1.237981 0 0 0.902991 11.432183-1.962365)\" fill=\"#F67280    \" stroke-width=\"0\" stroke-linecap=\"round\" stroke-linejoin=\"bevel\"\/><\/svg>\r\n");
}
...
const TabBar2 = React.forwardRef((props, ref) => {
    const html = getHtml();
